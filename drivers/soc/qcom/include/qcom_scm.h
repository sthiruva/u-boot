...
extern int qcom_scm_set_cold_boot_addr(void *entry, const uint64_t cpus);
extern int qcom_scm_set_warm_boot_addr(void *entry, const uint64_t cpus);
...
extern int qcom_scm_is_available(void);

extern int qcom_scm_hdcp_available(void);
extern int qcom_scm_hdcp_req(struct qcom_scm_hdcp_req *req, u32 req_cnt,
		u32 *resp);

extern int qcom_scm_pas_supported(u32 peripheral);
